...
public class ExceptionAdvice extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity onThrowException(GeneralException generalException, HttpServletRequest request) {
        ApiResponseDTO errorReasonHttpStatus = generalException.getErrorReasonHttpStatus();
        return handleExceptionInternal(generalException, errorReasonHttpStatus, null, request);
    }

    private ResponseEntity<Object> handleExceptionInternal(Exception e, ApiResponseDTO reason, HttpHeaders headers, HttpServletRequest request) {
